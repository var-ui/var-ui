...
export function Breadcrumbs({
  ...
  return (
    <nav aria-label={label} {...mergeProps(b.root, className)} style={style}>
      <AriaBreadcrumbs
        items={visibleItems}
      ...
      >
        {(item: VisibleItem) =>
          item.isEllipsis ? (
            <Breadcrumb id={item.id} {...mergeProps(b.ellipsisItem)}>
              <button
                type="button"
                {...mergeProps(b.link)}
            ...
            <Breadcrumb id={item.id} {...mergeProps(b.item)}>
              {/*
              ...
              */}
              <Link {...(item.href ? { href: item.href } : {})} {...mergeProps(b.link)}>
                {item.label}
              </Link>
            </Breadcrumb>
          )
