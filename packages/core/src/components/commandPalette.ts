...
export const commandPalette = styles.component(
  ...
  (c) => {
    ...
    return {
      ...
      base: {
        root: {
          [v.backdropBackground.name]: t.color.overlay.backdrop,
          [v.dialogBackground.name]: t.color.background.surface,
          [v.dialogBorder.name]: t.color.border.default,
          [v.inputRowBorder.name]: t.color.border.default,
          [v.inputIconColor.name]: t.color.text.placeholder,
          [v.inputForeground.name]: t.color.text.primary,
          [v.inputPlaceholder.name]: t.color.text.placeholder,
          [v.resultForeground.name]: t.color.text.primary,
          [v.resultHoverBackground.name]: t.color.accent.subtle,
          [v.resultMetaColor.name]: t.color.text.secondary,
          [v.markBackground.name]: t.color.accent.subtle,
          [v.markForeground.name]: t.color.text.primary,
